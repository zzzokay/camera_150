...
# -*- coding: utf-8 -*-
"""
单路 USB3 摄像头 + RKNN 检测 + 单目畸变矫正 + 1280x720 运镜录制。
...
流程：
    ...
    5. 根据导播状态在单图中做数字裁切，并 resize 到 1280x720 输出。
...
def run(args: argparse.Namespace) -> None:
    ...
    window_name = "single RKNN director view 1280x720"
    ...
    try:
        while not STOP_REQUESTED:
            ...
            _director_info = update_overlay_director_state(
                analysis,
                frame_w,
                frame_h,
                out_ratio,
            ...
            if args.print_every > 0 and frame_idx % args.print_every == 0:
                ...
                print(
                    ...
                    f"crop={crop_rect} rec={recorder.is_recording} "
